...
const PricingPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#F5F0E8] flex flex-col">
      ...
      <div className="max-w-5xl mx-auto w-full px-4 sm:px-6 pb-16 grid grid-cols-1 sm:grid-cols-3 gap-4">
        {PRICING_FEATURE_STRIPS.map((strip) => {
          const Icon = ICON_MAP[strip.icon];
          return (
            <div key={strip.id} className="bg-[#EFE9DF] rounded-2xl p-6 flex items-start gap-4">
